$(function () {
    ...
    $(window).on("load", function () {
        ...
        $(this).addClass("active_filter").siblings().removeClass("active_filter"), e.isotope({
            filter: t
        })
    });
    var t = ".page-right",
    ...
    $("#menu a:not(.loading)").on("click", function (e) {
        ...
        this.hash;
        if (e.preventDefault(), $(this).addClass("active_item").parent().siblings().find("a").removeClass("active_item"), "mobile_screen" === r())
            if (c(6), d(), "#home" === t) $(i).fadeIn(), $("section").removeClass("active_sec"), n(), C();
            else {
